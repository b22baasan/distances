...
# Date:
# version:
# Purpose: showing alternatives to ordination for displaying beta-diversity data with tidyverse in R
...
shared_df <- shared_tbl %>% 
        column_to_rownames('Group') # makes col to row names
...
ggsave("figures/one_day_lag_plot.png")
